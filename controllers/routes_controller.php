 ...
 */
class RoutesController extends RouteAppController {
	 ...
	 * @access public
	 */	
	var $components = array('Security', 'Session', 'Croutes');
    ...
    function admin_index() {
		...
		$this->set('routes', $this->paginate('Route'));				
    }
	...
	function admin_regenerate_custom_routes_file() {
		...
		$result = $this->Croutes->write_custom_routes_file();
